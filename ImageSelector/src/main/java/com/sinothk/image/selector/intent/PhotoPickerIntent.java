package com.sinothk.image.selector.intent;

import android.content.Context;
import android.content.Intent;

import com.sinothk.image.selector.ImageConfig;
...
public class PhotoPickerIntent extends Intent {
    ...
    /**
     * @param bool
     * @param appPackage 当前App
     */
    public void setShowCamera(boolean bool, String appPackage) {
        this.putExtra(PhotoPickerActivity.EXTRA_SHOW_CAMERA, bool);
        this.putExtra(PhotoPickerActivity.EXTRA_SHOW_CAMERA_PATH, appPackage);
    }
