...
public class PhotoPickerActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_SHOW_CAMERA_PATH = "EXTRA_SHOW_CAMERA_PATH";
    /**
     * 默认选择的数据集
     */
    ...
    private void initViews() {
        ...
        String appPackage = getIntent().getStringExtra(EXTRA_SHOW_CAMERA_PATH);
        captureManager = new ImageCaptureManager(mCxt, appPackage);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        TextView titleBarTxt = (TextView) findViewById(R.id.titleBarTxt);
        titleBarTxt.setText("选择图片");
    ...
    private void refreshActionStatus() {
        ...
        completeTv.setText(text);

        boolean hasSelected = resultList.size() > 0;

        completeTv.setVisibility(hasSelected ? View.VISIBLE : View.INVISIBLE);
